...
class ClienteModelTest(TestCase):
    ...
    def setUpTestData(cls):
        """Esse método é usado para configurar um objeto do tipo Cliente que servirá para todos os métodos de teste 
        desta classe.
        """
    ...
    def test_tamanho_do_telefone(self):
        """O método verificar se o campo 'telefone' está armazenando contatos com 11 digítos, que é o formato atual no 
        Brasil.
        """
        cliente = Cliente.objects.get(id=1)
    ...
    def test_telefone_unico(self):
        """Esse método verifica se o campo 'telefone' do modelo está corretamente configurado para receber valores 
        únicos.
        """
        cliente = Cliente.objects.get(id=1)
...
class ClienteViewTest(TestCase):
    ...
    def setUp(self):
        """Esse método é usado para criar um usuário e autentica-lo antes de cada método de teste.
        """
    ...
    def test_acesso_autenticado_clientes(self):
        """Testa se o código HTTP é 200, o que significa que o usuário consegue acessar a área de gerencimento de 
        clientes estando autenticado.
        """
        resposta = self.client.get(reverse("clientes:clientes"))
        self.assertEqual(resposta.status_code, 200)
        
    def test_acesso_acesso_desautenticado_clientes(self):
        """Testa se o código HTTP é 403, o que significa que o usuário não consegiu acessar a área de gerenciamento de 
        clientes, estando desautenticado.
        """
        self.client.logout()
        resposta = self.client.get(reverse("clientes:clientes"))
    ...
    def test_acesso_acesso_desautenticado_cadastrar_cliente(self):
        """Testa se o código HTTP é 403, o que significa que o usuário não consegiu acessar a área de cadastro de
        cliente, estando desautenticado.
        """
        self.client.logout()
    ...
    def test_acesso_acesso_desautenticado_atualizar_cliente(self):
        """Testa se o código HTTP é 403, o que significa que o usuário não consegiu acessar a área de atualização do 
        cadastro de cliente, estando desautenticado.
        """
        self.client.logout()
    ...
    def test_acesso_acesso_desautenticado_detalhes_cliente(self):
        """Testa se o código HTTP é 403, o que significa que o usuário não consegiu acessar a área de detalhamento de 
        cliente, estando desautenticado.
        """
        self.client.logout()
    ...
    def test_acesso_acesso_desautenticado_deletar_cliente(self):
        """Testa se o código HTTP é 403, o que significa que o usuário não consegiu acessar a área de exclusão de
        cliente, estando desautenticado.
        """
        self.client.logout()
